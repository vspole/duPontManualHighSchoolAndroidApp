 ...
 */
public class SHandBook extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.shandbook, container, false);
       ...
       // webSettings.setLoadWithOverviewMode(true);
        ...
        myWebView.loadUrl("http://docs.google.com/gview?embedded=true&url=http://www.dupontmanual.com/pubs/studenthandbook.pdf");
        return myView;
    }
