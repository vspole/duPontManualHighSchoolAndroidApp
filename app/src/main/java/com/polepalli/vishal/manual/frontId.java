...
public class frontId extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.front_id);
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(frontId.this);
        editor = preferences.edit();
        downloadUri = Uri.parse(preferences.getString("url", ""));
    ...
    public void show()
    {
        editor.putString("url",downloadUri.toString());
        editor.putInt("done",1);
        editor.apply();
        Picasso.with(frontId.this).load(downloadUri).fit().centerCrop().into(mImageView);
    }
